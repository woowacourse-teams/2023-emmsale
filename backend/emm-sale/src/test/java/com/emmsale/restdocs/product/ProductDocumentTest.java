...
public class ProductDocumentTest {
  ...
  void topPriceDropProductsTest() throws Exception {
    ...
    this.mockMvc.perform(get(PRODUCT_PATH + "/top-price-drop")
        ...
        .andDo(
            document("top-price-drop-products", requestHeaders, requestParameters, responseFields));
  }
  ...
  void searchProductsTest() throws Exception {
    ...
    this.mockMvc.perform(get(PRODUCT_PATH + "/search")
        ...
        .andExpect(status().isOk())
        .andDo(
            document("search-products", requestHeaders, requestParameters, responseFields));
  }
  ...
  void wishProductsTest() throws Exception {
    ...
    this.mockMvc.perform(get(PRODUCT_PATH + "/wish?notificationFilter=false")
        ...
        .andExpect(status().isOk())
        .andDo(
            document("wish-products", requestHeaders, requestParameters, responseFields));
  }
  ...
  void wishWithNotifiedProductsTest() throws Exception {
    ...
    this.mockMvc.perform(get(PRODUCT_PATH + "/wish?notificationFilter=true")
        ...
        .andExpect(status().isOk())
        .andDo(
            document("wish-with-notified-products", requestHeaders, requestParameters,
                responseFields));
  }
  ...
  void wishWithNoAuthorizationProductsTest() throws Exception {
    ...
    this.mockMvc.perform(get(PRODUCT_PATH + "/wish?notificationFilter=true")
        ...
        .andDo(
            document("wish-with-no-authentication-products", requestHeaders, requestParameters)
        );
  }
