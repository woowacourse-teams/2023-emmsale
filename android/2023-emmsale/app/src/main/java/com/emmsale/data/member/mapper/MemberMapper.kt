...
private fun List<ActivitiesAssociatedByActivityTypeApiModel>.toData(): List<Activity> =
    this.flatMap { it.toData() }

private fun ActivitiesAssociatedByActivityTypeApiModel.toData(): List<Activity> =
